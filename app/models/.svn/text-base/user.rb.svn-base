...
class User < ActiveRecord::Base
  ...
  validates_format_of       :email,    :with => Authentication.email_regex, :message => "debe ser una dirección de email correcta."
  ...
  attr_accessible :login, :email, :name, :password, :password_confirmation, :group_ids, :reset_code
  ...
  def create_reset_code
    ...
    write_attribute :reset_code, reset_code
    save(false)
  end 
  ...
  protected
    ...
    def make_activation_code
        self.deleted_at = nil
        write_attribute :activation_code, self.class.make_token
    end
